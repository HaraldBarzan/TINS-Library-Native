...
foreach(package_name IN LISTS package_names)
    ...
    vcpkg_cmake_configure(
        ...
        OPTIONS
            ...
            -DBUILD_TESTS=OFF
            # tins-lib-native overlay: fftw3's own CMakeLists.txt predates CMake 3.5 and was
            # never updated. CMake 4.x (what CI's runners use) hard-removed compatibility
            # with that. Passing this as an actual -D define (not a shell env var -- vcpkg
            # does not forward those into the cmake.exe it spawns per port, confirmed) is
            # CMake's own documented escape hatch for exactly this class of failure.
